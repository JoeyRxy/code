...
public class TrieST<Value> {
    ...
    /**
     * returns the length of the longest string key in the subtrie rooted at x that
     * is a prefix of the query string, assuming the first d character match and we
     * have already found a prefix match of given length (-1 if no such match)
     */

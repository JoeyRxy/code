...
public class MSD {
    ...
    /**
     * Rearranges the array of 32-bit integers in ascending order. Currently assumes
     * that the integers are nonnegative.
     *
     * @param a the array to be sorted
     */
    ...
    private static void sort(int[] a, int lo, int hi, int d, int[] aux) {
        ...
        /*************
         * BUGGGY CODE. // for most significant byte, 0x80-0xFF comes before 0x00-0x7F
         * if (d == 0) { int shift1 = count[R] - count[R/2]; int shift2 = count[R/2];
         * for (int r = 0; r < R/2; r++) count[r] += shift1; for (int r = R/2; r < R;
         * r++) count[r] -= shift2; }
         ************************************/
        // distribute
        for (int i = lo; i <= hi; i++) {
    ...
    /**
     * Reads in a sequence of extended ASCII strings from standard input; MSD radix
